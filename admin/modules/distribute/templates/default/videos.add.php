...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?act=videos&op=index" title="返回视频分类列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
        <h3>视频管理 - <?php echo $lang['nc_new'];?></h3>
        <h5>视频管理 - 添加，编辑，删除</h5>
      </div>
    </div>
  </div>
